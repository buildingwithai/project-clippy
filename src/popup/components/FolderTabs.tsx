...
export const FolderTabs: React.FC<FolderTabsProps> = ({ folders, activeFilterFolderId, setActiveFilterFolderId }) => {
  return (
    // TooltipProvider might be better placed higher in the component tree (e.g., App.tsx) if tooltips are used widely.
    // For now, placing it here to ensure these specific tooltips work.
